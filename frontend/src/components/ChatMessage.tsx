                                ...
                                components={{
                                    code({
                                        ...
                                        if (isInline) {
                                            return (
                                                <code
                                                    className="bg-primary/10 text-primary px-1.5 py-0.5 rounded-md font-mono text-[0.85em]"
                                                    {...props}
                                                >
                                                    {children}
                                                </code>
                                    ...
                                    blockquote: ({ children }) => (
                                        <blockquote className="border-l-2 border-primary/50 pl-4 py-1 my-4 bg-primary/5 italic text-muted-foreground rounded-r-lg">
                                            {children}
                                        </blockquote>
                                    ),
                                    h1: ({ children }) => (
                                        <h1 className="text-xl font-bold mb-4 mt-6 text-foreground tracking-tight">
                                            {children}
                                        </h1>
                                    ),
                                    h2: ({ children }) => (
                                        <h2 className="text-lg font-bold mb-3 mt-5 text-foreground tracking-tight">
                                            {children}
                                        </h2>
                                    ),
                                    h3: ({ children }) => (
                                        <h3 className="text-base font-bold mb-2 mt-4 text-foreground tracking-tight">
                                            {children}
                                        </h3>
                                    ),
                                }}
